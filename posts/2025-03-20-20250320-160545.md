---
title: "Post on 2025-03-20 16:05:45"
date: "2025-03-20 16:05:45"
---

# Data first, then storefront

I ran a pretty long set of seeding statements in a new Postgres:
...
<img alt="quick db studios in windmill" src="../images/seeded-db-mill.png" width="800" />

Now that I have these set up, I have a plan to try using [Kysely](https://kysely.dev) with the [code-sharing capabilities](https://www.windmill.dev/docs/advanced/sharing_common_logic) in Windmill, first by generating types from the scaffolded data with [kysely-codegen](https://github.com/RobinBlomberg/kysely-codegen). I would assume that this would then be something I need to do as part of the migration project every time i change models, which may be often since this is pretty fluid and I'm building data models from scratch. But I am confident that doing things this way will pay off since every solution I've used for this project so far as a black box has been objectively miserable.
